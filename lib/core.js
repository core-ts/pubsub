...
function createPubSub(projectId, credentials) {
  var pubsub = new pubsub_1.PubSub({ projectId: projectId, credentials: credentials });
  return pubsub;
}
...
function checkPermission(iam, permissionString, log) {
  return __awaiter(this, void 0, void 0, function () {
    var opt, permissions, err_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          _a.trys.push([1, 3, , 4]);
          return [4, iam.testPermissions(permissionString, opt)];
        case 2:
          permissions = _a.sent();
        ...
        case 3:
          err_1 = _a.sent();
          log("Cannot check permission " + permissionString + ": " + toString(err_1));
          return [3, 4];
        case 4: return [2];
      }
    });
